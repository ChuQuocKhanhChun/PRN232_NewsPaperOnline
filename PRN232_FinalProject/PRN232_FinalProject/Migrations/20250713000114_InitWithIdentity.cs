        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Articles__Author__45F365D3",
                        column: x => x.AuthorID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__Articles__Catego__46E78A0C",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HistoryID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ArticleID = table.Column<int>(type: "int", nullable: false),
                    EditedBy = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    EditedDate = table.Column<DateTime>(type: "datetime", nullable: true, defaultValueSql: "(getdate())"),
                    OldTitle = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__ArticleHi__Artic__571DF1D5",
                        column: x => x.ArticleID,
                        principalTable: "Articles",
                        principalColumn: "ArticleID");
                    table.ForeignKey(
                        name: "FK__ArticleHi__Edite__5812160E",
                        column: x => x.EditedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__ArticleLi__Artic__60A75C0F",
                        column: x => x.ArticleID,
                        principalTable: "Articles",
                        principalColumn: "ArticleID");
                    table.ForeignKey(
                        name: "FK__ArticleLi__UserI__619B8048",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ArticleT__4A35BF6C6586C92B", x => new { x.ArticleID, x.TagID });
                    table.ForeignKey(
                        name: "FK__ArticleTa__Artic__4CA06362",
                        column: x => x.ArticleID,
                        principalTable: "Articles",
                        principalColumn: "ArticleID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK__ArticleTa__TagID__4D94879B",
                        column: x => x.TagID,
                        principalTable: "Tags",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Bookmarks__Artic__5CD6CB2B",
                        column: x => x.ArticleID,
                        principalTable: "Articles",
                        principalColumn: "ArticleID");
                    table.ForeignKey(
                        name: "FK__Bookmarks__UserI__5BE2A6F2",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArticleHistory_EditedBy",
                table: "ArticleHistory",
                column: "EditedBy");
